...
import com.programmer2704.movapp.usage.PaginationListener
...
//    private lateinit var popularVM: MainViewmodel
    ...
    override fun onCreateView(
        ...
        //popularVM = ViewModelProvider(requireActivity()).get(MainViewmodel::class.java)
        // v before hilt
        //popularVM = ViewModelProviders.of(this).get(MainViewmodel::class.java)
